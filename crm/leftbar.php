  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="admin/assets/img/icon/employe.png"  alt="" data-src="admin/assets/img/icon/employe.png" data-src-retina="admin/assets/img/icon/employe.png" width="69" height="69" /> </div>
        <div class="user-info">
          ...
          <li class="active"><a href="change-password.php"><span class="fa fa-file-text-o"></span> Change Password</a></li>
                            <li><a href="profile.php"><span class="fa fa-user"></span> Profile</a></li>
                              ...
                              <!--<li ><a href="get-quote.php"> <span class="fa fa-tasks"></span> Request a Quote</a></li>-->
							     ...
							     <li class="active"><a href="create-ticket.php"><span class="fa fa-ticket"></span> Customer Complaint</a></li>

                                <li ><a href="view-tickets.php"><span class="fa fa-ticket"></span> View Complaint</a></li>
