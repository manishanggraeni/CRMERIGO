  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">View Halaman Complaint</a></li>
      </ul>
      <div class="page-title"> <i class="icon-custom-left"></i>
        <h3>Halaman Customer Complaint </h3>
      </div>
      <div class="clearfix"></div>

      <h4> <span class="semi-bold">Complaint</span></h4>
      <br>
...
<script src="admin/assets/js/support_ticket.js" type="text/javascript"></script>
