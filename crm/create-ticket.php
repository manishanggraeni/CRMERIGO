...
$a=mysqli_query($con,"insert into ticket(ticket_id,email_id,subject,task_type,ticket,status,posting_date)  values('$tid','$email','$subject','$tt','$ticket','$st','$pdate')");
if($a)
{
...
<meta charset="utf-8" />
<title>CRM | Create  Complaint</title>
									 ...
									 <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <select  name="tasktype" class="form-control select" required>
                                                <option> Pilihan Kategori Complaint</option>
                                                <option value="billing">Pelayanan</option>
                                                <option value="ot1">Pengiriman</option>
                                                <option value="ot2">Pembayaran</option>
                                                <option value="ot3">Barang</option>
                                            </select>
                                           </div>
                                    </div>
