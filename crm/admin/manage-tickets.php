...
$fid=$_POST['frm_id'] ;
$sql = "update ticket set admin_remark='$adminremark', status = 'Sudah Direspon' where id='$fid'";
mysqli_query($con,$sql);
echo '<script>alert("Respon Complaint Has Been Sent.")</script>';
}
?>
<!DOCTYPE html>
<html>
...
<meta charset="utf-8" />
<title>User | Halaman Complaint</title>
  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
          ...
          <li><a href="#" class="active">Customer Complaint</a>

          </li>
      </ul>
      <div class="page-title">	<i class="icon-custom-left"></i>

            <h3>Manage Customer Complaint </h3>
      </div>
      <div class="clearfix"></div>

      <h4> <span class="semi-bold">Complaint Masuk</span></h4>
      <br>
