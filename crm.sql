...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2019 at 05:16 AM
...
INSERT INTO `broadcast` (`id_broadcast`, `id_admin`, `judul_broadcast`, `isi_broadcast`, `tgl_broadcast`) VALUES
(1, 1, 'Menuju Tahun Baruuuuu !!!', 'Ada promo terbaru dari Erigoo... Segera Kunjungi Toko Kami.\r\nPesan ini hanya dikirimkan kepada penerima pesan ini.', '2019-10-09'),
(2, 1, 'Promo', 'Promo', '2019-01-03');

-- --------------------------------------------------------

--
-- Table structure for table `det_broadcast`
--

CREATE TABLE `det_broadcast` (
  `id_broadcast` int(11) NOT NULL,
  `id_admin` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(12, '5', 'manishanggraeni@gmail.com', 'Keluhan', 'ot1', 'important', 'Pengiriman jelek', '', 'Open', 'oke akan kami perbaiki', '2019-11-27', '2019-11-27 09:20:20'),
(13, '6', 'manishanggraeni@gmail.com', 'Fira Aprilia', 'ot1', 'question', 'Apakah aku lapar ?', '', 'Open', 'Aku kenyang', '2019-11-27', '2019-11-27 10:45:58'),
(14, '7', 'manishanggraeni@gmail.com', 'Fira Aprilia', 'ot1', 'question', 'Apakah aku lapar ?', '', 'Open', '', '2019-11-27', NULL);
...
INSERT INTO `transaction` (`id_transaksi`, `nama`, `waktu_transaksi`, `jml_pemesanan`, `total_pembayaran`) VALUES
(1, 'Daniel James', '2019-11-26 13:40:27', 1, 'Rp. 150.000'),
(2, 'Largie Ramazani', '2019-11-26 13:43:40', 3, 'Rp. 500.000'),
(3, 'Mason Greenwood', '2019-11-27 09:12:28', 1, 'Rp. 400.000'),
(4, 'Rahul', '2019-11-27 10:21:24', 5, 'Rp. 829.500');
...
(13, 'manis', 'manishanggraeni@gmail.com', NULL, '12345', '081711633012', 'f', NULL, NULL, NULL, '2019-11-27 09:17:38');
...
(112, '2019/11/27', '02:48:34pm', 13, 'manis', 'manishanggraeni@gmail.com', 0x3a3a31, 0x32412d32412d34342d33352d34342d34, '', ''),
(113, '2019/11/27', '04:05:58pm', 13, 'manis', 'manishanggraeni@gmail.com', 0x3a3a31, 0x42302d36452d42462d41422d30302d36, '', ''),
(114, '2019/11/27', '04:11:26pm', 13, 'manis', 'manishanggraeni@gmail.com', 0x3a3a31, 0x42302d36452d42462d41422d30302d36, '', ''),
(115, '2019/11/28', '04:10:38am', 13, 'manis', 'manishanggraeni@gmail.com', 0x3a3a31, 0x42302d36452d42462d41422d30302d36, '', ''),
(116, '2019/11/29', '04:39:12am', 13, 'manis', 'manishanggraeni@gmail.com', 0x3a3a31, 0x42302d36452d42462d41422d30302d36, '', ''),
(117, '2019/11/29', '05:41:01am', 13, 'manis', 'manishanggraeni@gmail.com', 0x3a3a31, 0x42302d36452d42462d41422d30302d36, '', '');
